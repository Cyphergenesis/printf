...
int display_char(va_list list, char buffer[], int flags, int width, int precision, int size);
int display_string(va_list list, char buffer[], int flags, int width, 
 			int precision, int size);
int _percent(va_list list, char buffer[], int flags, int width, int precision, int size);
...
int display_binary(va_list list, char buffer[], int flags, int width, 
 		int precision, int size);
int display_unsigned(va_list list, char buffer[], int flags, int width, int precision, int size);
int write_octal(va_list list, char buffer[], int flags, int width, int precision, int size);
int display_hex(va_list list, char buffer[], int flags, int width, int 
 		precision, int size);
...
int rot13_string(va_list list, char buffer[], int flags, int width, int precision, int size);


/*Write handlers*/
int print_unsign(int non_negative, int index, char buffer[], int flags, int width, int precision, int size);
int _write_char(char c, char buffer[], int flags, int width, int precision, int size);
int display_num(int non_negative, int index, char buffer[], int flags, int width, int precision, int size);
int write_buffer(int index, char buffer[], int flags, int width, int precision, int length, char pad, char ch);
int _pointer_write(char buffer[], int ind, int length, int width, int flags, char pad, char ch, int pad_srt);
int create_print(const char *ft, int *index, va_list list, char buffer[], int flags, int width, int precision, int size);
